...
Route::get('location-category-list', [API\LocationCategoryController::class, 'getLocationCategoryList']);
...
Route::get('configurations', [API\DashboardController::class, "configurations"]);
  ...
  //Ecommerce Section apis

  Route::get('shop', [API\EcommerceController::class, 'shops']);
  Route::get('product', [API\EcommerceController::class, 'getProducts']);
  Route::get('category', [API\EcommerceController::class, 'getShopCategory']);

...
Route::group(['middleware' => ['auth', 'verified']], function()
{
    ...
    Route::group(['middleware' => ['permission:category list']], function () {
        Route::resource('location-category', LocationCategoryController::class);
        Route::get('location/index_data',[LocationCategoryController::class,'index_data'])->name('location-category.index_data');
        Route::post('location/category-bulk-action', [LocationCategoryController::class, 'bulk_action'])->name('location-category.bulk-action');
        Route::post('category-action',[LocationCategoryController::class, 'action'])->name('location-category.action');
        Route::post('category/{id}', [LocationCategoryController::class, 'destroy'])->name('location-category.destroy');
        Route::post('check-in-trash', [LocationCategoryController::class, 'check_in_trash'])->name('check-in-trash');
    ...
    Route::get('shops',[EcommerceController::class,'index'])->name('shop.index');
    Route::get('shops-index-data',[EcommerceController::class,'index_data'])->name('shop.index-data');
    Route::get('shop/create',[EcommerceController::class,'create'])->name('shop.create');
    Route::post('shop/create',[EcommerceController::class,'store'])->name('shop.store');
    Route::post('shop-bulk-action',[EcommerceController::class, 'bulk_action'])->name('shop.bulk_action');
    Route::post('shop-action',[EcommerceController::class, 'action'])->name('shop.action');
    Route::Delete('shop/{id}', [EcommerceController::class, 'destroy'])->name('shop.destroy');

                    ...
                    <div class="card-body">
                        {{ Form::model($subcategory,['method' => 'POST','route'=>'subcategory.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'subcategory'] ) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('name_ar',trans('messages.name_ar').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::text('name_ar',old('name_ar'),['placeholder' => trans('messages.name_ar'),'class' =>'form-control','required']) }}
                                    <small class="help-block with-errors text-danger"></small>
                                </div>

                    ...
                    <div class="card-body">
                        {{ Form::model($servicefaq,['method' => 'POST','route'=>'servicefaq.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'servicefaq'] ) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('title_ar',trans('messages.title_ar').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::text('title_ar',old('title'),['placeholder' => trans('messages.title_ar'),'class' =>'form-control','required']) }}
                                    <small class="help-block with-errors text-danger"></small>
                                </div>
                                <div class="form-group col-md-4">

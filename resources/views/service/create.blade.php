                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                {{ Form::label('name', __('messages.name_ar') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false) }}
                                {{ Form::text('name_ar', old('name_ar'), ['placeholder' => __('messages.name_ar'), 'class' => 'form-control', 'title' => 'Please enter alphabetic characters and spaces only']) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                <label>{{__('messages.location_category')}}</label>
                                <select class="select2js form-group" name="location_category">
                                    @if(count($locationCategory))
                                        @foreach($locationCategory as $locationCat )
                                        <option {{$locationCat->name == $servicedata->location_category ? 'selected':'' }} value="{{ $locationCat->name}}">{{ $locationCat->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                {{ Form::label('description_ar', __('messages.description_ar'), ['class' => 'form-control-label']) }}
                                {{ Form::textarea('description_ar', null, ['class' => 'form-control textarea', 'rows' => 3, 'placeholder' => __('messages.description_ar')]) }}
                            </div>

    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            @if ($auth_user->can('category list'))
                                <a href="{{ route('location-category.index') }}" class="float-right btn btn-sm btn-primary"><i
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($categorydata, ['method' => 'POST', 'route' => 'location-category.store', 'enctype' => 'multipart/form-data', 'data-toggle' => 'validator', 'id' => 'location-category']) }}
                        {{ Form::hidden('id') }}
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                {{ Form::label('name_ar', __('messages.name_ar') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false) }}
                                {{ Form::text('name_ar', old('name_ar'), ['placeholder' => __('messages.name_ar'), 'class' => 'form-control', 'required', 'title' => 'Please enter alphabetic characters and spaces only']) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                {{ Form::label('description_ar', trans('messages.description_ar'), ['class' => 'form-control-label']) }}

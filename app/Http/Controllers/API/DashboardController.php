...
class DashboardController extends Controller
{
    public function dashboardDetail(Request $request)
    {
        ...
        if(isset($city)){
            $service = Service::where('status',1)->where('service_type','service')->where('location_category',$city);
        ...
        if(isset($city)){
            $featured_service =  Service::where('status',1)->where('is_featured',1)->where('service_type','service')->where('location_category',$city);
        }else{

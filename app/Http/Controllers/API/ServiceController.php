...
class ServiceController extends Controller
{
    ...
    public function getServiceDetail(Request $request){
        ...
        $titleAttribute = ($language === 'ar') ? 'title_ar' : 'title';
        $descriptionAttribute = ($language === 'ar') ? 'description_ar' : 'description';
        $servicefaq_data = $servicefaq->map(function ($faq) use ($titleAttribute,$descriptionAttribute) {
            return [
                'id'    => $faq->id,
                'title' => $faq->{$titleAttribute},
                'description'  => $faq->{$descriptionAttribute},

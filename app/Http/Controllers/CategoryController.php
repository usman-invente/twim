        ...
        return $datatable->eloquent($query)
            ...
            ->editColumn('name', function ($query) {
                if (auth()->user()->can('category edit')) {
                    if (app()->getLocale() == "ar") {
                        $link = '<a class="btn-link btn-link-hover" href=' . route('category.create', ['id' => $query->id]) . '>' . $query->name_ar . '</a>';
                    } else {
            ...
            ->editColumn('description', function ($query) {
                if (auth()->user()->can('category edit')) {
                    if (app()->getLocale() == "ar") {
                        $link =  $query->description_ar;
                    } else {
                        $link =  $query->description;
                    }
                } else {
                    $link = app()->getLocale() == 'ar' ? $query->description_ar : $query->description;
                }
                return $link;
            })

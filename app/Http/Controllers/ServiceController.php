...
use App\Http\Requests\LocationCategory;
...
use App\Models\LocationCategory as ModelsLocationCategory;
...
class ServiceController extends Controller
{
        ...
        return $datatable->eloquent($query)
            ...
            ->editColumn('name', function($query){
                if (auth()->user()->can('service edit')) {
                    if (app()->getLocale() == "ar") {
                        $link =  '<a class="btn-link btn-link-hover" href=' . route('service.create', ['id' => $query->id]) . '>' . $query->name_ar . '</a>';
                    } else {
    ...
    public function create(Request $request)
    {
        ...
        $servicedata = Service::find($id);
         $locationCategory = ModelsLocationCategory::all();
        ...
        return view('service.create', compact('pageTitle', 'servicedata', 'auth_user', 'settingdata','locationCategory','advancedPaymentSetting','visittype'));
    }
